          ...
          <div>
            ...
            <ul className="space-y-6 text-[#8888a0]">
              ...
              <li className="flex items-center gap-4 pt-2">
                <svg className="w-6 h-6 text-[#00cec9] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:hello@risoftware.agency" className="hover:text-white transition-colors text-base font-medium">
              ...
              <li className="flex items-center gap-4">
                ...
                <a href="tel:+15551234567" className="hover:text-white transition-colors text-base font-medium">
                  +1 (555) 123-4567
                </a>
              </li>
            </ul>
