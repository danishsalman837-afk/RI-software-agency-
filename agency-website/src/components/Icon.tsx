import {
  ...
  User, Mail, Phone, Check, ArrowRight, Plus, Minus,
  type LucideIcon,
} from "lucide-react";
...
export function IconTile({
  ...
  return (
    <div
      className={`flex-shrink-0 w-10 h-10 bg-[#161616] border border-[#262626] flex items-center justify-center text-white transition-all duration-150 ${className}`}
    >
